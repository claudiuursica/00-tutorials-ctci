...
describe('Function: rotateMatrix', () => {
  ...
  it('should throw error', () => {
    const test_Empty_matrix = [];
    
    expect(function() {rotateMatrix(test_Empty_matrix) }).toThrowError('Invalid matrix.');
  
    const rotated_2X3_matrix = [
      [3, 1],
      [4, 2],
      [5, 6]
    ];
  
    expect(function() {rotateMatrix(rotated_2X3_matrix) }).toThrowError('Invalid matrix.');
  });
